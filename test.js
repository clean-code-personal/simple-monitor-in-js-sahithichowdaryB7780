...
describe('batteryIsOk function', function () {
    it('should return true if all parameters are within normal range', function () {
        ...
        console.log('Temperature status:', result.temperatureMessage);
        console.log('SoC status:', result.socMessage);
        console.log('Charge rate status:', result.chargeRateMessage);
    });
